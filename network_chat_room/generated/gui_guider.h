...
typedef struct
{
	...
	lv_obj_t *screen_main_friend_list;
	lv_obj_t *screen_main_friend_list_item0;
	lv_obj_t *screen_main_search_cont;
	lv_obj_t *screen_main_imgbtn_14;
	lv_obj_t *screen_main_imgbtn_14_label;
	lv_obj_t *screen_main_ta_9;
