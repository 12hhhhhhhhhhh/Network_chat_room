...
__attribute__((unused)) static void ta_screen_create_event_cb(lv_event_t *e)
{
	...
	{
		lv_zh_keyboard_set_textarea(kb, NULL);
...
void setup_scr_screen_create(lv_ui *ui){
	...
	g_kb_screen_create = lv_zh_keyboard_create(ui->screen_create, &lv_font_simsun_18);
	...
	lv_obj_set_pos(ui->screen_create_label_9, 210, 220);
	lv_obj_set_size(ui->screen_create_label_9, 100, 32);
	lv_obj_set_scrollbar_mode(ui->screen_create_label_9, LV_SCROLLBAR_MODE_OFF);
	lv_label_set_text(ui->screen_create_label_9, "密码：");
	...
	lv_obj_set_pos(ui->screen_create_label_10, 160, 275);
	...
	lv_label_set_text(ui->screen_create_label_10, "确认密码：");
	...
	//Write codes screen_create_spangroup_1
	ui->screen_create_spangroup_1 = lv_spangroup_create(ui->screen_create);
	lv_obj_set_pos(ui->screen_create_spangroup_1, 270, 330);
	lv_obj_set_size(ui->screen_create_spangroup_1, 300, 26);
	lv_obj_set_scrollbar_mode(ui->screen_create_spangroup_1, LV_SCROLLBAR_MODE_OFF);
	lv_spangroup_set_align(ui->screen_create_spangroup_1, LV_TEXT_ALIGN_LEFT);
	lv_spangroup_set_overflow(ui->screen_create_spangroup_1, LV_SPAN_OVERFLOW_CLIP);
	lv_spangroup_set_mode(ui->screen_create_spangroup_1, LV_SPAN_MODE_EXPAND);

	//Set style for screen_create_spangroup_1. Part: LV_PART_MAIN, State: LV_STATE_DEFAULT
	lv_obj_set_style_radius(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_create_spangroup_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_color(ui->screen_create_spangroup_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_grad_dir(ui->screen_create_spangroup_1, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_color(ui->screen_create_spangroup_1, lv_color_make(0x21, 0x95, 0xf6), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_opa(ui->screen_create_spangroup_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_spread(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_x(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_ofs_y(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_color(ui->screen_create_spangroup_1, lv_color_make(0x00, 0x00, 0x00), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_width(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_border_opa(ui->screen_create_spangroup_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->screen_create_spangroup_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//create spans
	lv_span_t *screen_create_spangroup_1_span;

	//create a new span
	screen_create_spangroup_1_span = lv_spangroup_new_span(ui->screen_create_spangroup_1);
	lv_span_set_text(screen_create_spangroup_1_span, "Tips:please input infomation!");
	lv_style_set_text_color(&screen_create_spangroup_1_span->style, lv_color_make(0x3c, 0x3c, 0x3c));
	lv_style_set_text_decor(&screen_create_spangroup_1_span->style, LV_TEXT_DECOR_NONE);
	lv_style_set_text_font(&screen_create_spangroup_1_span->style, &lv_font_arial_20);
	lv_spangroup_refr_mode(ui->screen_create_spangroup_1);
	...
	lv_label_set_text(ui->screen_create_btn_1_label, "注册");
	...
	lv_label_set_text(ui->screen_create_label_11, "注册成功！");
	...
	lv_obj_set_style_text_color(ui->screen_create_label_11, lv_color_make(0x3c, 0x3c, 0x3c), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_create_label_12, "密码错误！");
	...
	lv_obj_set_style_text_color(ui->screen_create_label_12, lv_color_make(0x3c, 0x3c, 0x3c), LV_PART_MAIN|LV_STATE_DEFAULT);
