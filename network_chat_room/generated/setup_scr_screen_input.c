...
void setup_scr_screen_input(lv_ui *ui){
	...
	lv_img_set_src(ui->screen_input_img_3,&_4_2_alpha_80x80);
	...
	lv_imgbtn_set_src(ui->screen_input_imgbtn_6, LV_IMGBTN_STATE_RELEASED, NULL, &_21_1_alpha_50x40, NULL);
	lv_imgbtn_set_src(ui->screen_input_imgbtn_6, LV_IMGBTN_STATE_PRESSED, NULL, &_21_2_alpha_50x40, NULL);
	lv_imgbtn_set_src(ui->screen_input_imgbtn_6, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_21_1_alpha_50x40, NULL);
	lv_imgbtn_set_src(ui->screen_input_imgbtn_6, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_21_2_alpha_50x40, NULL);
	...
	lv_imgbtn_set_src(ui->screen_input_imgbtn_7, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, &_9_alpha_50x40, NULL);
	lv_imgbtn_set_src(ui->screen_input_imgbtn_7, LV_IMGBTN_STATE_CHECKED_PRESSED, NULL, &_9_1_alpha_50x40, NULL);
